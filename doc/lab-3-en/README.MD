...
The number of columns used to display the images must be different based on rezolution (please use [CSS media queries](https://web.dev/learn/design/media-queries/)):
