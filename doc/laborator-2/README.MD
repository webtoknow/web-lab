...
Totodata, ne putem ajuta developer.mozilla.org pentru a aprofunda [selectorii](https://developer.mozilla.org/en-US/docs/Learn/CSS/Building_blocks/Selectors).
